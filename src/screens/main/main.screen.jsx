      ...
      <form className='cep-container'>
        <label className='cep-input-label'>CEP:
          <div className='cep-input-container'>
            <input className={`cep-input ${!cepInfo && 'invalid-input'}`} name='cep' value={inputValue.cep} placeholder='Número do CEP' disabled={isCepLoading} onChange={handleInputValueChange} onBlur={handleInputCepBlur} />
